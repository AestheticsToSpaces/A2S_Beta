        ...
        <div className="relative w-full rounded-2xl overflow-hidden" style={{ background: '#F9F8F6', border: '1px solid #EAEAEA' }}>
            ...
            <div className="p-4 flex items-center gap-3" style={{ borderBottom: '1px solid #EAEAEA' }}>
                ...
                <div className="flex-1">
                    <div className="h-3 w-48 rounded-full animate-pulse" style={{ background: 'linear-gradient(90deg, #E5E5E5 0%, #D4AF37 50%, #E5E5E5 100%)', backgroundSize: '200% 100%', animation: 'shimmer 2s infinite' }} />
                </div>
                <span className="text-[9px] font-bold uppercase tracking-wider px-2 py-1 rounded-full" style={{ background: '#D4AF37', color: 'white' }}>Scanning</span>
            </div>
            {/* Vendor rows */}
            <div className="p-3 space-y-2">
                {vendors.map((v, i) => (
                    ...
                    >
                        <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[10px] font-black" style={{ background: v.type === 'Artisan' ? '#D4AF37' : v.type === 'Local' ? '#7C3AED' : '#0EA5E9', color: 'white' }}>
                            {v.name.charAt(0)}
                        </div>
                        <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <span className="text-xs font-bold" style={{ color: '#D4AF37' }}>{v.score}</span>
                        </div>
                    </div>
                ))}
            </div>
                ...
                {step === 1 && (
                    <div className="flex flex-col items-center justify-center py-6" style={{ animation: 'fadeIn 0.4s ease-out' }}>
                        <div className="w-20 h-20 rounded-full flex items-center justify-center mb-4 relative" style={{ border: '2px solid #7C3AED', background: 'rgba(124,58,237,0.05)' }}>
                            ...
                            <div className="absolute inset-0 rounded-full" style={{ border: '2px solid transparent', borderTopColor: '#D4AF37', animation: 'spin 1.5s linear infinite reverse' }} />
                        </div>
                        ...
                        <div className="w-48 h-2 rounded-full overflow-hidden" style={{ background: '#EDE9FE' }}>
                            <div className="h-full rounded-full" style={{ background: 'linear-gradient(90deg, #7C3AED, #D4AF37)', animation: 'shimmer 1.5s ease-in-out infinite', width: '70%' }} />
                        </div>
...
const ThreeDStudioDemo = () => (
    <div className="relative w-full rounded-2xl overflow-hidden" style={{ background: '#F9F8F6', border: '1px solid #EAEAEA' }}>
        ...
        <div className="relative p-6" style={{ minHeight: '220px', background: 'linear-gradient(180deg, #FAFAFA 0%, #F0F0F0 100%)' }}>
            ...
            <div className="absolute top-20 right-12 px-3 py-2 rounded-lg text-[10px] font-bold shadow-lg" style={{ background: 'white', border: '2px solid #D4AF37', color: '#333', animation: 'floatSlow 3s ease-in-out 0.5s infinite' }}>
                🪑 Chair
            </div>
...
const HeroSection = () => {
    ...
    return (
        <section 
            ...
            aria-label="Hero" 
            className="w-full bg-[#FAF7F2] relative overflow-hidden pt-20"
        >
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16 py-20">
                ...
                <div className="flex-1 w-full relative group animate-fade-in-up stagger-4">
                    ...
                    >
                        ...
                        {/* The Scanline */}
                        <div className="absolute top-0 bottom-0 left-0 w-[2px] bg-gradient-to-b from-transparent via-accent to-transparent shadow-[0_0_20px_rgba(212,175,55,0.8)] animate-scan-x pointer-events-none" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                        {[
                            ...
                            <div key={title} className="text-center group cursor-pointer p-8 rounded-[40px] hover:bg-white/40 transition-all duration-700 hover:shadow-premium border border-transparent hover:border-premium">
                                <div className="w-16 h-16 rounded-3xl mx-auto mb-6 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 shadow-lg shadow-accent/5" style={{ background: 'rgba(212,175,55,0.1)', border: '1px solid rgba(212,175,55,0.15)' }}>
                                    <Icon size={24} style={{ color: '#B8973E' }} />
                                </div>
                                <h3 className="font-serif text-2xl font-black mb-3 italic" style={{ color: '#2A2017' }}>{title}</h3>
    ...
    return (
        <main className="w-full bg-main min-h-screen transition-all duration-1000 relative overflow-hidden" role="main">
            ...
            <section ref={whyRef} className="py-24 md:py-32 bg-surface transition-all duration-1000" aria-labelledby="why-heading">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className={`mt-20 p-10 md:p-14 rounded-[40px] bg-main border border-premium relative overflow-hidden ${whyInView ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '0.5s' }}>
                        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-30%,rgba(212,175,55,0.08),transparent)]" />
            ...
            <section ref={ctaRef} className="py-24 md:py-32 bg-main relative overflow-hidden transition-all duration-1000">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_50%,rgba(212,175,55,0.1),transparent)]" />
